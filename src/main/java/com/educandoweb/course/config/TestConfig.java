...
@Profile("test")	//so vai rodar esta configuração quando estiver no perfil de teste
public class TestConfig implements CommandLineRunner{	//CommandLineRunner - usado para rodar quando o programa for iniciado
	...
	public void run(String... args) throws Exception { //CommandLineRunner
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"),OrderStatus.PAID, u1); //id, momento, status, usuario
		...
		//salvando as instanciacoes no bd
